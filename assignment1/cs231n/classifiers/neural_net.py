...
class TwoLayerNet(object):
  ...
  We train the network with a softmax.ipynb loss function and L2 regularization on the
  weight matrices. The network uses a ReLU nonlinearity after the first fully
  connected layer.

  In other words, the network has the following architecture:

  input - fully connected layer - ReLU - fully connected layer - softmax.ipynb
  ...
  """
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        #TODO: Maybe use softmax on W1 and W2
        # Compute the data loss. This net uses softmax loss
